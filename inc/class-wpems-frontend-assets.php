...
class WPEMS_Frontend_Assets {
	...
	public static function register_scripts( $hook ) {
		...
		if( function_exists('bp_is_active') ) {
			...
			if( ( bp_is_active( 'groups' ) && bp_is_group() ) || ( is_page('omicslogic') ) ) {
 
				//Buddypress
				WPEMS_Assets::register_script( 'wpems-buddypress-js', WPEMS_ASSETS_URI . '/js/frontend/bp-timeline.js', array( 'jquery' ), WPEMS_VER, true );
				WPEMS_Assets::register_style( 'wpems-buddypress-css', WPEMS_ASSETS_URI . '/css/frontend/bp-timeline.css' );
